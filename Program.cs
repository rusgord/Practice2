...
namespace Practice_Linq
{
    public class Program
    {
        ...
        static void Query3(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game => game.Country == "France" && game.Date.Year == 2021 && game.Home_score == game.Away_score)
                .OrderBy(game => game.Date.Year);
        ...
        static void Query5(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game => game.Tournament == "UEFA Euro qualification" && (game.City == "Kharkiv" || game.City == "Kyiv") && game.Home_team == "Ukraine" && game.Home_score > game.Away_score)
                .OrderBy(game => game.Date.Year);
        ...
        static void Query7(List<FootballGame> games)
        {
            ...
            FootballGame g = games
                .First(game => game.Date.Year == 2023 && (game.Home_team == "Ukraine" && game.Home_score > game.Away_score || game.Away_team == "Ukraine" && game.Away_score > game.Home_score));
